...
all_data_2022 <- data.frame(
    ...
    taxied = ifelse(all_data_2022_raw$Did.it.taxi..move.in.auto.., T, F),
    ...
    total_auto_points = (
        ...
        ifelse(all_data_2022_raw$Did.it.taxi..move.in.auto.., 2, 0)
    ),
    total_teleop_points = (
        all_data_2022_raw$X..of.Low.Goals.Scored.2 +
        all_data_2022_raw$X..of.High.Goals.Scored.2 * 2
    ),
    total_endgame_points = lapply(all_data_2022_raw$Climb.Level, endgame_points_2022)
)
...
all_data_2023 <- data.frame(
    ...
    total_endgame_points = lapply(all_data_2023_raw$Endgame.Status, endgame_points_2023)
)

get_team_data_2022 <- function(team_number) {
    #
}
```
