...
```{r plot_bodlen_comp, echo=FALSE, out.height="4in", out.width="6in"}
BodLen_comparison_density_plot()
```

```{r plot_duration_comp, echo=FALSE, out.height="4in", out.width="6in"}
Duration_comparison_density_plot()
```

```{r plot_amplitude_comp, echo=FALSE, out.height="4in", out.width="6in"}
...
t.test(fishdata$C.BodLen - fishdata$R.BodLen)
```
...
t.test(fishdata$C.Duration - fishdata$R.Duration)
```
...
t.test(fishdata$C.Amplitude - fishdata$R.Amplitude)
```
...
Unfortunately, none of the differences were statistically significant at the 0.05 level. 
The most significant of the three variables here is the body length, with a p-value of
0.06749. Duration and amplitude had p-values of 0.1203 and 0.3031, respectively. The test
that I ran was a matched pairs difference of means t-test. 
...
```{r plot_duration_vs_bodlen, echo=FALSE, out.height="4in", out.width="6in"}
...
```{r plot_amplitude_vs_bodlen, echo=FALSE, out.height="4in", out.width="6in"}
...
```{r plot_amplitude_vs_duration, echo=FALSE, out.height="4in", out.width="6in"}
